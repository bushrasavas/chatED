...
// import React, { useEffect, useState } from 'react';
// import { View, Text, ScrollView, StyleSheet, ActivityIndicator } from 'react-native';
// import { postWithToken } from '../utils/api'; // Bunu kullanıyoruz
...
//       const { status, data } = await postWithToken('history', {}); // POST isteği boş body ile
...
//               <Text style={styles.userMessage}>You: {item.user_message}</Text>
//               <Text style={styles.botMessage}>Bot: {item.bot_response}</Text>
